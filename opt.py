...
parser.add_argument('--class_num', default=2811, dest='class_num', help='number of the class')
parser.add_argument('--data_path', default="./datasets/VRIC", help='path of dataset')
