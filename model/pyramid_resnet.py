...
class Model(nn.Module):
    def __init__(self):
        ...
        self.classifier_11 = nn.Linear(in_features=512, out_features=9999, bias=False) # opt.class_num
        self.color_11 = nn.Linear(in_features=512, out_features=120, bias=False)

        self.bottleneck_22 = nn.BatchNorm1d(512)
        self.bottleneck_22.bias.requires_grad_(False)
        self.classifier_22 = nn.Linear(in_features=512, out_features=9999, bias=False)
        self.color_22 = nn.Linear(in_features=512, out_features=120, bias=False)

        self.bottleneck_33 = nn.BatchNorm1d(512)
        self.bottleneck_33.bias.requires_grad_(False)
        self.classifier_33 = nn.Linear(in_features=512, out_features=9999, bias=False)
        self.color_33 = nn.Linear(in_features=512, out_features=120, bias=False)
